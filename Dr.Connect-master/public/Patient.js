  ...
  db.collection("Patient").get().then(function(querySnapshot) {
    querySnapshot.forEach(function(doc) {
        if(patientEmail == doc.data().PatientEmail){
          listitem.innerHTML = "<div><p>Patient Number: " + doc.data().PatientNumber + "<br><br> Patient Email:  " + doc.data().PatientEmail + "<br><br> Patient Address: " + doc.data().PatientAddress + "<br><br> PatientID: " + doc.data().PatID +  "</p></div>";
